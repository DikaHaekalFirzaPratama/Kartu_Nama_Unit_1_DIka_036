...
fun BusinessCard() {
    Column(
        ...
        Text(text = "Dika Haekal Firza Pratama", color = Color.White, fontSize = 32.sp)
        Text(text = "Mahasiswa Uin Sunan Gunung Djati Bandung", color = Color(0xFF3ddc84))
    }
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = "dikahaekalfirza@gmail.com",
                color = Color.White,
                modifier = Modifier.padding(8.dp)
            )
